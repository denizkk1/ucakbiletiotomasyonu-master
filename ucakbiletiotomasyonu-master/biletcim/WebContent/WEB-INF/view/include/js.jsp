...
<script src="${pageContext.request.contextPath }/resources/js/jquery.min.js"></script>
  ...
  <script src="${pageContext.request.contextPath }/resources/js/datedropper.js"></script>
  <script src="${pageContext.request.contextPath }/resources/js/custom-select-ticket-date.js"></script></html>
